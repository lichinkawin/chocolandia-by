  ...
  <div class="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-screen-2xl flex-col justify-center px-4 pb-16 pt-[calc(72px+2rem)] sm:px-6 lg:px-12">
    <div class="max-w-2xl">
      ...
      <div class="mt-10 flex flex-wrap gap-4">
        <a href="/#cat-%D0%9F%D0%B0%D1%81%D1%85%D0%B0" class="inline-flex min-w-[200px] items-center justify-center rounded-md bg-gradient-to-r from-primary-cocoa to-primary-container px-10 py-4 text-sm font-semibold text-white shadow-[0_20px_50px_-20px_rgba(39,19,16,0.55)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_24px_56px_-18px_rgba(39,19,16,0.5)]">${escapeAttr(settings.hero_cta_primary)}</a>
        <a href="/#about" class="inline-flex min-w-[180px] items-center justify-center rounded-md border border-white/35 bg-white/5 px-10 py-4 text-sm font-semibold text-white backdrop-blur-md transition duration-300 hover:bg-white/12">${escapeAttr(settings.hero_cta_secondary || "О мастерской")}</a>
      </div>
    </div>
  </div>
</section>`;
